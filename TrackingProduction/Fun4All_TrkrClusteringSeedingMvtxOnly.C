...
#include </sphenix/u/gregoryottino/macros/common/Trkr_Reco_Cosmics_Mvtx.C>
    ...
    //const std::string dir = "/sphenix/lustre01/sphnxpro/commissioning/aligned_streaming_all_4/")
{
  ...
  ntp->set_trkclus_seed_container("SiliconTrackSeedContainer");
  ntp->Verbosity(0);
